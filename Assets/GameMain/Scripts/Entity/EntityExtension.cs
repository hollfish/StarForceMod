...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void ShowEnemy(this EntityComponent entityCompoennt, EnemyAircraftData data)
        {
            entityCompoennt.ShowEntity(typeof(Enemy), "Enemy", Constant.AssetPriority.EnemyAsset, data);
        }
